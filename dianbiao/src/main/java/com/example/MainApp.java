...
//        Map<String,String> configMap = getMap(config);
    ...
    public static void readZhaoDongSbSbl(Workbook workbook, Map<String, String> bzhmcConfigMap, Map<String, String> ipysConfigMap) throws IOException {
    ...
    public static void readExcelFile(String filePath,int type, Map<String, String> bzhmcConfigMap, Map<String, String> ipysConfigMap) throws IOException {
        ...
        if (type==0) {
            readZhaoDongSbSbl(workbook,bzhmcConfigMap, ipysConfigMap);
